...
class JshoppingControllerProducts extends JshoppingControllerBaseadmin{
    ...
    function edit(){
        ...
        $lists['categories'] = JHTML::_('select.genericlist', $categories, 'category_id[]', 'class="inputbox" size="30" multiple = "multiple" '.$category_select_onclick, 'category_id', 'name', $categories_select);
