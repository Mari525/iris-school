...
<div class="product productitem_<?php print $product->product_id?>">
    ...
    <div class="name">
        ...
        <?php if ($this->config->product_list_show_product_code){?>
            <div class="jshop_code_prod">(<?php print _JSHOP_EAN?>:  <?php print $product->product_ean;?>     )</div>
        <?php }?>
    </div>
            ...
            <div class="image_block">
                ...
                <?php if ($product->label_id){?>
                    <div class="product_label">
                        <?php if (  ($product->_label_image) AND (1==0) )   {?>
        ...
        <?php if ($product->product_old_price > 0){?>
            <div class="old_price">
                <?php if ($this->config->product_list_show_price_description) print _JSHOP_OLD_PRICE.": ";?>
                 ...
                 <?php print formatprice($product->product_old_price)?><?php print $product->_tmp_var_old_price_ext?>
  ...
  <td>
     ...
     <td>
           <a class="btn button_detail" href="<?php print $product->product_link?>">
               <div>   <?php print _JSHOP_DETAIL?>    </div>
            </a>
     </td>
  </tr>
</table>
