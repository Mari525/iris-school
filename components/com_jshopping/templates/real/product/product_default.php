...
<div class="jshop productfull" id="comjshop">
    <form name="product" method="post" action="<?php print $this->action?>" enctype="multipart/form-data" autocomplete="off">
        ...
        <h1><?php print $this->product->name?><?php if ($this->config->show_product_code){?>
        <div class="jshop_code_prod" id="product_code" >(<?php print _JSHOP_EAN?>:
...
<table id="productfull_table"  >
   ...
   <tr>
    <td id="productfull_left" style="vertical-align:top" >
        <!-- 111 -->
    ...
    <td id="productfull_right" style="vertical-align:top" >
        <!-- 111 -->
...
<div class="prod_qty_input">
    ...
    <table>
      ...
      <?php print _JSHOP_QUANTITY?>:
                 <input type="text" name="quantity" id="quantity" onkeyup="reloadPrices();" class="inputbox" value="<?php print $this->default_count_product?>" />
...
<div class="buttons product-buttons">
    ...
    <?php if ($this->config->product_show_button_back){?>
        <div class="button_back">
            <input type="button" class="btn button"   style=" background-color:#848890; color:#fff "     value="<?php print _JSHOP_BACK;?>" onclick="<?php print $this->product->button_back_js_click;?>" />
        </div>
    <?php }?>
