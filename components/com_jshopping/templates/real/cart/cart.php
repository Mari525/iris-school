    ...
    <tr class="jshop_prod_cart <?php if ($i % 2 == 0) print "even"; else print "odd"?>">
        ...
        <td class="product_name">
            ...
            <div class="data">
                ...
                <?php if ($this->config->show_product_code_in_cart) { ?>
                    <span class="jshop_code_prod">(Код <?php print $prod['ean'] ?>)</span>
                <?php } ?>
        ...
        <td class="quantity">
            ...
            <div class="data">
                                ...
                                <?php }else{?>
                                        <input type = "text" id="mobquantity<?php print $key_id ?>" name = "quantity[<?php print $key_id ?>]" value = "<?php print $prod['quantity'] ?>" class = "inputbox" />
                                    шт.
                                <?php }?>
...
<div class = "jshop cart_buttons">
    <div id = "checkout">
          ...
          <!--    -->
            <a href = "<?php print $this->href_shop ?>" class="btn btn-arrow-left"  style="display:none"   >
