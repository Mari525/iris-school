...
<script>
	jQuery(window).load(function(){
		...
		jQuery('.task-help .container-fluid.container-main .span2').css('height',$sidebar_scroll_height);
...
<div>
	...
	<li><a href="#change_db_prefix" data-toggle="tab"><?php echo JText::_('COM_CHANGE_DB_PREFIX');?></a></li>
	</ul>
...
<p>4) Website administrator can view blocked country logs in jSecure Backend</p>
	...
	<div class="tab-pane" id="change_db_prefix">
		<table class="table-striped-jsecure" width="100%">
		<tr>
		<td>
		<p>Changing the database table prefix is an easy way for an attacker to destroy your website. Our change db prefix functionality prevents hackers from damaging the database by changing its prefix.</p>
		</td>
		</tr>
		</table>
		<table>
		<td style="line-height:18px; padding:8px;">
		<p>1) It provides an ability to change the prefix of database to protect your website from hackers.</p>
		<p>2) Admin can generate random prefix from website admin.</p>
		<p>3) It has the ability to rollback the transaction during changing if something goes wrong thus protecting the website from damage.</p>
		<p>4) It always keeps recent backup of your database when change db prefix operation is performed.</p>
		</td>
		</table>
	</div>
	</div>
...
<div>
	...
	<li><a href="#whois_lookup_information" data-toggle="tab"><?php echo JText::_('COM_JSECURE_WHOIS');?></a></li>
	</ul>
	...
	<div class="tab-pane" id="view_log_tab">
	   ...
	   <div class="tab-pane" id="manage_ips_from_log">
		...
		<div class="tab-pane" id="whois_lookup_information">
		<table class="table-striped-jsecure" width="100%">
		<tr>
		<td>
			<p>Using WHOIS Lookup tool website administrator can find out the domain’s name servers (DNS) information used for service</p>
		</td>
		</tr>
		</table>
		</div>
...
<h2><?php echo JText::_('Change log'); ?></h2>
	...
	<table>
		<tr>
			...
			<p><b>Thanks to</b> the team (Ajay Lulia,Bhavin Shah,Anurag Soni,Omkar Ambre) for developing the Component and Plugin.</p>
		...
		<tr>
			<td style="line-height:18px; padding:8px;">
                        ...
                        <p><b>3.5(12-Dec-2016):</b><br/><br/>   
			    1. Change Database Prefix</br>
                            2. Country Block for website's frontend</br>
                            3. Whois Lookup</br>
                            4. New Dashboard</br>
			</p>
