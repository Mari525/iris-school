...
function display($tpl=null){
    ...
    $app->redirect($link,$msg,'MESSAGE');
		...
		$config_array['countryfrnt_options']         =  JRequest::getVar('countryfrnt_options', 0, 'post', 'int');
		$config_array['custom_path']				 =  $oldValue->custom_path;		
		$config_array['country_front_custom_path']	 =  JRequest::getVar('country_front_custom_path','', 'post', 'string');		
