...
--
-- Table structure for table `#__jsecure_blackiplist`
--
DROP TABLE IF EXISTS `#__jsecure_blackiplist`;
CREATE TABLE `#__jsecure_blackiplist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `iptype` int(50) NOT NULL,
  `ip` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;
--
-- Dumping data for table `#__jsecure_blackiplist`
--

--
-- Table structure for table `#__jsecure_whiteiplist`
--
DROP TABLE IF EXISTS `#__jsecure_whiteiplist`;
CREATE TABLE `#__jsecure_whiteiplist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `iptype` int(50) NOT NULL,
  `ip` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `#__jsecure_whiteiplist`
--

DROP TABLE IF EXISTS `#__jsecure_license`;
CREATE TABLE `#__jsecure_license` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
