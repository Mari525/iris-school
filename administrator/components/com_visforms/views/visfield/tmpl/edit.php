...
$fieldTypesWithOptionlist = array('visf_multicheckbox_options', 'visf_radio_options', 'visf_select_options');?>

<script type="text/javascript">
    function removeUnused(selected) {
        var fieldType = ['text', 'email', 'date', 'url', 'number', 'password', 'hidden', 'textarea', 'checkbox', 'multicheckbox', 'radio', 'select', 'file', 'image', 'reset', 'submit', 'fieldsep', 'pagebreak', 'calculation', 'location', 'signature'];
    ...
    <div class="form-horizontal"><?php
        ...
        <div class="row-fluid form-horizontal-desktop">
            ...
            <div class="span6"><?php
                ...
                foreach ($groupFieldSets as $name => $fieldSet) {
                    if (in_array($name, $fieldTypesWithOptionlist)) {continue;}?>
        ...
        <div class="row-fluid form-horizontal-desktop">
            <div class="span12"><?php
                foreach ($fieldTypesWithOptionlist as $name) {
