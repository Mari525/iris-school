...
abstract class JHtmlVisforms
{
    ...
    public static function replacePlaceholder($form, &$text = '') {
	    ...
	    if (!empty($matches)) {
		    foreach ($matches as $match) {
			    ...
			    if (empty($pName)) {
				    // should never happen: just remove the placeholder
			    }
			    else if (array_key_exists($pName, VisformsPlaceholder::$nonFieldPlaceholder)) {
				    ...
				    foreach ($form->fields as $field) {
					    ...
					    if ($pName === $fieldName) {
						    ...
						    $placeholder = VisformsPlaceholder::getInstance($pParams, $field->dbValue, $field->typefield, $field);
						    $replace = $placeholder->getReplaceValue();
						    break;
					    }
				    }
    ...
    public static function getVisToolTipTemplate() {
    	return '<div class="tooltip vistt bs-tooltip-top" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>';
    }
