...
class JFormFieldVflayouts extends JFormFieldList
{
	...
	protected function getInput() {
		...
		if (!empty($hasBt4)) {
			$bt4mcindividual = new StdClass();
			$bt4mcindividual->value = 'bt4mcindividual';
			$bt4mcindividual->text = JText::_('COM_VISFORMS_BOOTSTRAP4_MULTICOLUMN_INDIVIDUAL');
			$bt4mcindividual->disabled = false || ($this->readonly && 'bt4mcindividual' != $this->value);
			$bt4mcindividual->checked = false;
			$bt4mcindividual->selected = false;
			$options[] = $bt4mcindividual;
		}
