...
class N2GeneratorRSEventsProEvents extends N2GeneratorAbstract {
    ...
    public function renderFields($form) {
        ...
        new N2ElementText($date, 'rseventsoffset', 'Date variable offset', '', array(
            'tip' => n2_('Timezone offset in hours. For example: +2 or -7. If you leave it empty, Joomla\'s System -> Global Configuration -> Server -> Server Time Zone setting will be used.')
        ));

        new N2ElementText($date, 'rseventsfilteroffset', 'Date filter offset', '', array(
            'tip' => n2_('Timezone offset in hours. For example: +2 or -7. If you leave it empty, Joomla\'s System -> Global Configuration -> Server -> Server Time Zone setting will be used.')
        ));
