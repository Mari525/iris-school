...
class N2GeneratorJomSocialEvents extends N2GeneratorAbstract {
    ...
    public function renderFields($form) {
		...
		new N2ElementText($date, 'dateformat', n2_('Date format'), 'Y-m-d');
		new N2ElementText($date, 'timeformat', n2_('Time format'), 'H:i');
    ...
    protected function _getData($count, $startIndex) {
		...
		$timeFormat = $this->data->get('timeformat', 'H:i');
        ...
        for ($i = 0; $i < count($result); $i++) {
            ...
            $r += array(
                ...
                'start_date' => $this->formatDate($result[$i]['startdate'], $dateFormat),
                'start_time' => $this->formatDate($result[$i]['startdate'], $timeFormat),
                'end_date'   => $this->formatDate($result[$i]['enddate'], $dateFormat),
                'end_time'   => $this->formatDate($result[$i]['enddate'], $timeFormat),
