...
class N2GeneratorEasySocialAlbums extends N2GeneratorAbstract {
    ...
    public function renderFields($form) {
        ...
        new N2ElementEasySocialCategories($source, 'easysocialgroups', n2_('Groups'), 0, array(
            'isMultiple'  => true,
            'size'        => 10,
        ...
        new N2ElementEasySocialCategories($source, 'easysocialevents', n2_('Events'), 0, array(
            'isMultiple'  => true,
            'size'        => 10,
            'table'       => 'social_clusters',
            'clusterType' => 'event',
        ...
        new N2ElementEasySocialCategories($source, 'easysocialpages', n2_('Pages'), 0, array(
            'isMultiple'  => true,
            'size'        => 10,
            'table'       => 'social_clusters',
            'clusterType' => 'page',
