...
class N2SmartsliderSlidersModel extends N2Model {
    ...
    private static function editForm($data = array()) {
        ...
        $fadeInSlider = new N2ElementGroup($loadingCore, 'fade-on-load', n2_('Fade in slider'), array(
            'tip' => n2_('When disabled the slider won\'t wait for the CSS codes to display the layers where they should be. Instead, they\'ll jump into their places after the CSS codes are ready.')
        ));
        ...
        new N2ElementImageListFromFolderValue($loadingCore, 'spinner', n2_('Loading animation'), 'simpleWhite', array(
            ...
            'rowClass' => 'n2-white',
            'tip'      => n2_('This option only works with "Fade in - on load" and it doesn\'t work with "Fade in - on scroll".')
        ));
        ...
        $slideBackgroundLightbox = new N2ElementGroup($slidesCore, 'lightbox', n2_('Lightbox from slide backgrounds'), array(
            'tip' => n2_('This feature only works if all slides have background images.')
        ));
