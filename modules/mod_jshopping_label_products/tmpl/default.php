...
<?php         print $product->_tmp_var_bottom_foto;?>
            ...
            <div class="jshop_code_prod">(<?php print _JSHOP_EAN?>: <span><?php print $product->product_ean;?></span>)</div>
            <?php }?>
        </div>
...
<?php                 if ($product->product_old_price > 0){// option modul product_old_price?>
                <div class="old_price"><?php if ($jshopConfig->product_list_show_price_description) print _JSHOP_OLD_PRICE.": ";?>     <?php print formatprice($product->product_old_price)?>    </div>
<?php                 }?>
...
<?php                }?>
<?php
; //print $product->_tmp_var_buttons;
?>
        </div>

<?php
print $product->_tmp_var_bottom_buttons;
?>
