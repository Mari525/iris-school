...
$formLink = (!empty($base = Juri::base(true)) ? Juri::base(true) . '/' : '') . "index.php?option=com_visforms&task=visforms.send&id=" . $visforms->id . ((!empty($correspondingMenuId)) ? "&Itemid=" . $correspondingMenuId : "");
